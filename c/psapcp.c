...
char ch[10][130]={"Sharma Travels","Saini Travels","Prasanna-Purple Travels","Shree Khurana Shabrij Travels","Dolphin Travel House","Super Travels"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
    ...
    do
{
	...
	i=0;
		...
		if(strcmp(uname,"Shyam")==0 && strcmp(pword,"1234")==0)
	{
	printf("  \n\n\n       LOGIN IS SUCCESSFUL. WELCOME TO OUR SYSTEM !!!!");
	...
	if (a>2)
	{
		printf("\nYou have entered the wrong username and password for more than 2 times!!!");
